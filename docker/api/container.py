...
class ContainerApiMixin(object):
    ...
    def add_nvidia_docker_to_config(self, container_config, image, *args,
                                    **kwargs):
        try:
    ...
    def create_container_config(self, *args, **kwargs):
        container_config = ContainerConfig(self._version, *args, **kwargs)

        self.add_nvidia_docker_to_config(container_config, *args, **kwargs)
